...
class ResNet50_layer4(nn.Module):
    def __init__(self, num_classes= 10): # Hint : How many classes in Cifar-10 dataset?
        ...
        self.layer1 = nn.Sequential(
            nn.Conv2d(3, 64, 7, 2, 3), # params => in_channels, out_channels, kernel_size, stride, padding
            ...
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),
            nn.MaxPool2d(3, 2, 1) # params => kernel_size, stride, padding
        )
        ...
        # nn.Linear :: params => in_features, out_features
        self.fc = nn.Linear(1024, num_classes) # Hint : Think about the reason why fc layer is needed
        self.avgpool = nn.AvgPool2d(2, 1) # params => kernel_size, stride
