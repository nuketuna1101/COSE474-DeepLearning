...
data_dir = "C:/Users/ghj45/DL_project3/VOCdevkit/VOC2012"  ## <- change my local direction
resize_size = 256
...
## <1> model from UNet_skeleton.py code
model = Unet(3, 22)
PATH = './UNet_trained_model.pth'

## <2> model from resnet_encoder_unet_skeleton.py code
#model = UNetWithResnet50Encoder()
#PATH = './resnet_encoder_unet.pth' # test acc would be almost 80
...
# parameters
epochs = 1 ## As the trained checkpoint parameters are used, you will train model only 1 epoch.
...
for epoch in range(epochs):
    ...
    if epoch % 4 == 0:
        ...
        torch.save(model.state_dict(), './UNet_trained_model_final.pth')
        #torch.save(model.state_dict(), './resnet_encoder_unet_final.pth')
        ###
